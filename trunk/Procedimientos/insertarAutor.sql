...
FOR ID IN BUSQUEDA LOOP
    ...
    validarTDA(nombreCompleto, telefonos);
      ...
      INSERT INTO AUTOR
       (idAutor, pasaporte, nombreCompleto, telefono, sexo, fechaNacimiento, fallecimiento, foto, fkLugar, detalleDireccion)
      VALUES 
