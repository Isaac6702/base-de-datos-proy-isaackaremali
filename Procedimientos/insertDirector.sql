...
FOR ID IN BUSQUEDA LOOP
    ...
    validarTDA(nombreCompleto, telefonos);
      ...
      INSERT INTO Director
       (IDDIRECTOR, NOMBRECOMPLETO, TELEFONO, SEXO, FECHANACIMIENTO, FALLECIMIENTO, FOTO, FKLUGAR, DETALLEDIRECCION)
      VALUES 
