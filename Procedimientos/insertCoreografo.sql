...
FOR ID IN BUSQUEDA LOOP
    ...
    validarTDA(nombreCompleto, telefonos);
      ...
      INSERT INTO COREOGRAFO
       (IDCOREOGRAFO, NOMBRECOMPLETO, TELEFONO, SEXO, FECHANACIMIENTO, FALLECIMIENTO, FOTO, FKLUGAR, DETALLEDIRECCION)
      VALUES 
